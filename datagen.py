...
srcDirBare = os.path.join('/media/cae/data2/capture-output', dataSet)
srcDirTrain = os.path.join('/media/cae/data2/augInput', args.name + '-train', 'images')
srcDirValidate = os.path.join('/media/cae/data2/augInput', args.name + '-validate', 'images')
